...
class SettingsViewModelTest {
    ...
    @Test
    fun `initial state loads observed settings`() = runTest {
    ...
    @Test
    fun `initial state has default ui values`() = runTest {
        val viewModel = SettingsViewModel(repository)
        val state = viewModel.state.value
    ...
    // ── UserSettingsChanged action ─────────────────────────────────────────

    @Test
    fun `user settings change updates state and saves`() = runTest {
        val viewModel = SettingsViewModel(repository)

        viewModel.onAction(SettingsAction.OnUserSettingsChanged(
    ...
    @Test
    fun `user settings change with imperial units updates UI`() = runTest {
    ...
    @Test
    fun `valid weight updates state and saves`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `weight below minimum shows error`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `weight above maximum clamps to max`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `non-numeric weight shows error`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    // ── Age change validation ──────────────────────────────────────────────

    @Test
    fun `valid age updates state and saves`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `age below minimum shows error`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `age above maximum clamps to max`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `valid bike weight updates state and saves`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `bike weight below minimum shows error`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `bike weight with decimal point accepted`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `bike type change saves`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `tab selected updates state`() = runTest {
        val viewModel = SettingsViewModel(repository)
    ...
    @Test
    fun `save failure sends error event`() = runTest {
